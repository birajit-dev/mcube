...
export function OurStats() {
  return (
    <section className="container mx-auto grid gap-10 px-8 py-10 lg:grid-cols-1 lg:gap-20 xl:grid-cols-2 xl:place-items-center" style={{ backgroundColor: '#FEF2F2', borderRadius: '10px' }}>
